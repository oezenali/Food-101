...
test_data = test_data.map(lambda x, y: (tf.image.resize(x, (224, 224)) / 255.0, y)).batch(16)

# Model dosyasının yolu
model_path = "C:\\Users\\oezen\\OneDrive\\Masaüstü\\PROJE01\\EfficentNetB0\\food101_model_efficientnetb0_finetuned_epoch_47.h5"

if os.path.exists(model_path):
    model = build_model_efficientnetb0(info.features['label'].num_classes)
