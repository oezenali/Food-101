...
def on_isleme(goruntu, etiket):
    goruntu = tf.image.resize(goruntu, [224, 224])  # EfficientNetB0 için boyut
...
temel_model = tf.keras.applications.EfficientNetB0(include_top=False, input_shape=(224, 224, 3), weights='imagenet')
...
kontrol_noktasi = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/oezen/OneDrive/Masaüstü/PROJE01/food101_model_efficientnetb0_finetuned_epoch_{epoch:02d}.h5',
