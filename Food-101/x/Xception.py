...
def on_isleme(goruntu, etiket):
    goruntu = tf.image.resize(goruntu, [299, 299])  # Xception için önerilen girdi boyutu
...
# Xception modelini temel alarak yeni bir model oluşturma
temel_model = tf.keras.applications.Xception(include_top=False, input_shape=(299, 299, 3), weights='imagenet')
...
kontrol_noktasi = tf.keras.callbacks.ModelCheckpoint(
    'C:/Users/oezen/OneDrive/Masaüstü/PROJE01/food101_model_xception_finetuned_epoch_{epoch:02d}.h5',
